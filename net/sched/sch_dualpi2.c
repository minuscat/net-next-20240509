 ...
 *   you should use a Prague compliant CC for use on the Internet.
 *
 * References:
...
static const struct nla_policy dualpi2_policy[TCA_DUALPI2_MAX + 1] = {
	...
	[TCA_DUALPI2_COUPLING]		=
		NLA_POLICY_FULL_RANGE(NLA_U8, &dualpi2_nonzero_range),
			  ...
			  struct netlink_ext_ack *extack)
{
	...
	if (tb[TCA_DUALPI2_LIMIT])
		WRITE_ONCE(sch->limit, nla_get_u32(tb[TCA_DUALPI2_LIMIT]));
